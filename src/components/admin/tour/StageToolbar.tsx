...
const TOOLS: { id: ActiveTool; label: string; key: string; Icon: typeof CursorIcon }[] = [
  { id: "select", label: "Xoay", key: "Esc", Icon: CursorIcon },
  { id: "NAVIGATION", label: "Chuyển cảnh", key: "N", Icon: ArrowRightIcon },
  { id: "INFO", label: "Thông tin", key: "I", Icon: InfoIcon },
];

// Thanh công cụ nổi ngay trên ảnh panorama: chọn công cụ rồi bấm lên ảnh để
// đặt điểm. Công cụ đặt điểm là "một lần" — đặt xong tự quay về "Xoay" để
// tránh lỡ tay bấm thêm hotspot khi đang định kéo ảnh.
